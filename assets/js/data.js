...
if(form) {
    form.addEventListener('submit', function(event) {
        ...
        addPost(codeInput.innerText, nameInput.value, descInput.value, langInput.value, colorInput.value); // call addPost function with input box current value
    });
};
...
function addPost() {
    ...
    if (codeInput.innerText !== '') {
      ...
      console.log(post);
     // console.log(codeInput.textContent(String.raw));
        ...
        posts.forEach(function(post) {  
            ...
            <div class="post__wrapper"> 
                <div class="post__code code-card" style="background-color:${post.color};">
                    ...
                    <pre><code class="code-card__input hljs ${post.language}" contenteditable="false">${post.code}</code></pre>
                </div> 
